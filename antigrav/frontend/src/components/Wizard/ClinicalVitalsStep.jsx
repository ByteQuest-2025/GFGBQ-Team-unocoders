...
const RangeSlider = ({ label, value, onChange, min, max, unit, icon }) => {
        ...
        <div className="mb-6">
            <div className="flex justify-between items-end mb-2">
                <label className="text-sm font-bold text-slate-700 flex items-center gap-2">
                    <span className="p-1.5 bg-cyan-50 text-cyan-600 rounded-lg">{icon}</span>
                    {label}
                </label>
                <div className="font-mono font-bold text-cyan-600 bg-cyan-50 px-3 py-1 rounded-lg text-sm">
            ...
            <div className="relative h-6 flex items-center group">
                ...
                <div className="absolute w-full h-2 bg-slate-100 rounded-full overflow-hidden">
                    <div
                        className="h-full bg-gradient-to-r from-cyan-400 to-teal-500 transition-all duration-150 ease-out"
                ...
                />
                {/* Thumb Visual (optional, but standard range input covers functionality) */}
                <div
                    className="w-5 h-5 bg-white border-2 border-cyan-500 rounded-full shadow-md absolute pointer-events-none transition-all duration-150 ease-out group-hover:scale-110"
...
const ClinicalVitalsStep = () => {
    ...
    return (
        <div className="animate-fade-in-up">
            <h2 className="text-2xl font-bold text-slate-900 mb-2">Clinical Vitals</h2>
            <p className="text-slate-500 mb-8 text-sm">Use the sliders to input your current measurements.</p>
